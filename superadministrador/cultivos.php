<?php
    ...
    c.nombre AS cultivonombre, sr.descripcion AS descripcionsistema, c.id AS idcultivo, ic.nombre_cultivo AS cultivotipo FROM cultivos c left join usuarios u on (c.usuario_id = u.id) left join sistema_riego sr on (c.sistema_riego_id = sr.id)
    left join sensor_temp_hum s on (c.sensor_humedad_id = s.id) left join meses m on (c.inicio_cultivo_id = m.id) 
    left join inf_cultivos ic on (c.infcultivos_id = ic.id) where c.estatus = '1'";
...
<body id="body">
    ...
    <div class="contenedor_login">
        <a href="crear_cultivo.php"><button>Añadir Cultivo</button></a>
        ...
        <table id="tabla_cultivos">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $datoscultivo['cultivotipo']?></td>
                        ...
                        consulta_cultivo=<?php echo $datoscultivo['cultivotipo']?> &
                        ...
                        <a href="grafica_cantidad_agua.php?
                        sistema_riego_id=<?php echo $datoscultivo['sistema_riego_id']?>"><button class="registro">Reporte</a></button>
                        <a href="../php/desac_cultivo.php?
                        id=<?php echo $datoscultivo['idcultivo']?>" class="textoeliminar"><button class="eliminar">Desactivar</a></button>
                        </td>
                    </tr>
                <?php
                }
