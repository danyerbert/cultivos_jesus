<?php
    ...
    $sensoresregistrados = "SELECT * FROM sensor_temp_hum WHERE estatus = '0'";
...
<body id="body">
    ...
    <main>
        <h1>SENSORES DE HUMEDAD Y TEMPERATURA DESACTIVADOS</h1>
        <br>
    <div class="contenedor_login">
        <a href="../php/excel_sensores_hum_desac.php"><button>Exportar Registros</button></a>
        <a href="sensores_humedad.php"><button>Sensores Activos</button></a>
        <table id="tabla_sensores_hum">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="../php/act_sensor.php?
                        id=<?php echo $datossensor['id']?>"><button class="activar">Activar</a></button>
                        </td>
                    </tr>
                <?php
                }
