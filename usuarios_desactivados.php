<?php
    ...
    $usuariosregistrados = "SELECT * FROM usuarios where estatus = '0'";
...
<body id="body">
    ...
    <div class="menu_lateral" id="menu_lateral">
        ...
        <div class="opciones_menu">
            ...
            <a href="usuarios.html" class="seleccion">
                <div class="opcion">
    ...
    <div class="contenedor_login">
        <a href="php/excel_usuarios_desactivados.php"><button>Exportar Registros</button></a>
        <a href="usuarios.php"><button>Usuarios Activos</button></a>
        <table id="tabla_inf_cultivos">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $infusuario['tipo_documento']?> - <?php echo $infusuario['documento_identidad']?></td>
                        ...
                        <a href="php/act_usuario.php?
                        id=<?php echo $infusuario['id']?>" class="textoeliminar"><button class="activar">Activar</a></button>
                        </td>
                    </tr>
                <?php
                }
