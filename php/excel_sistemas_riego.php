...
$query=mysqli_query($conexion,"SELECT * FROM sistema_riego WHERE estatus = '1'");
$documento_sistema_riego="sistema_riego.xls";
...
echo '<table border=1>';
echo '<tr>';
echo '<th colspan=6 rowspan=2>Informacion Sistemas de Riego Registrados</th>';
echo '</tr>';
echo '<tr>';
echo '</tr>';
