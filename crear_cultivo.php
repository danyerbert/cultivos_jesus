...
<body id="body">
    ...
    <main>
        <h1>Crear un Cultivo</h1>
        <br>
        <div class="contenedor_login">
            <form action="php/registro_cultivo.php" method="post" class="formulario_registro">
                ...
                <br>
                <select name="sensor_humedad" required>
                    <option value=""></option>
                   <?php 
                ...
                <br>
                <br> 
                <label>Mes Inicio de Cultivo:</label>
                <br>
                <select name="mes_inicio_cultivo" required>
                    <option value=""></option>
                   <?php 
                        foreach ($datosmeses as $datosmes) {
                    ?>
                    <option value="<?php echo $datosmes['id']?>"><?php echo $datosmes['nombre']?></option>
                    <?php
                }
                ?>  
                </select>
                ...
                <br>
                <select name="sistema_riego" required>
                    <option value=""></option>
                    <?php 
