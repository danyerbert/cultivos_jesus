...
<head>
    ...
    <title>Registrar Sistema de Riego</title>
...
<body id="body">
    ...
    <main>
        <h1>Registrar un nuevo Sistema de Riego</h1>
        <br>
    <div class="contenedor_login">
        <form action="../php/registro_sistema_riego.php" method="post" class="formulario_registro">
