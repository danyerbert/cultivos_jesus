...
<head>
    ...
    <title>Registrar Sensor Humedad</title>
...
<body id="body">
    ...
    <main>
        <h1>Registrar un nuevo Sensor de Humedad y Temperatura</h1>
        <br>
    <div class="contenedor_login">
        <form action="php/registro_sensor.php" method="post" class="formulario_registro">
            <input type="text" placeholder="Numero de Bien Nacional" name="numero_bien_nacional" required>
            <br>
